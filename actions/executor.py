...
def _call_tool(tool: str, parameters: dict, speak: Callable | None) -> str:
    ...
    if tool == "open_app":
        ...
        return file_processor(parameters=parameters, player=None) or "Done."

    elif tool == "cmd_control":
        from actions.cmd_control import cmd_control
        return cmd_control(parameters=parameters, player=None) or "Done."

    elif tool == "run_project":
        from actions.project_launcher import run_project
        return run_project(parameters=parameters, player=None) or "Done."
        ...
        return whatsapp(parameters=parameters, player=None, speak=speak) or "Done."
        ...
        return currency_converter(parameters=parameters, player=None) or "Done."
