...
class OpenAIProvider(CloudProviderBase):
    """OpenAI provider adapter with live model discovery and execution."""
    ...
    default_models = [
        {"id": "gpt-4o", "name": "GPT-4o", "streaming": True, "vision": True, "tool_calling": True, "context_length": 128000, "extra": {"reasoning": True}},
        {"id": "gpt-4o-mini", "name": "GPT-4o Mini", "streaming": True, "vision": True, "tool_calling": True, "context_length": 128000, "extra": {}},
    ]
    ...
    def discover_models(self):
        ...
        for item in payload.get("data", []):
            ...
            models.append({
                ...
                "extra": {"owned_by": item.get("owned_by"), "created": item.get("created")},
            })
