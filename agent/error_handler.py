...
ERROR_ANALYST_PROMPT = """You are the error recovery module of Lessan AI assistant.
...
Return ONLY the Python code, no explanation."""
    ...
    try:
        code = client.chat(
            prompt,
            system="You are an expert Python developer. Return ONLY raw Python code, no explanation, no markdown.",
            temperature=0.2,
        ).strip()
